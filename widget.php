...
function AlobaidiRandomBannersWidget_register_widget(){
	return register_widget('AlobaidiRandomBannersWidget');
}
add_action ('widgets_init', 'AlobaidiRandomBannersWidget_register_widget');